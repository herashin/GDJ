...
public class Ex02 {
	...
	public static void main(String[] args) {
		...
		// 논리 NOT : ! , true 는 false/ false는 true
		...
		System.out.println("연습문제 n: " + result7);
		
		
		// 연습
		// 변수 x를 1증가시킨 뒤 x 가 10과 같으면 true, 아니면 false
		int x = 9;
		boolean result8 = ++x == 10;
		System.out.println("x값은 : " + x);
		System.out.println("문제 8 : " + result8);
		...
		// 위에 i의 값이 20이 아니기 때문에 AND 연산자는 더이상 작동을 안하고 종료됨. 
		// 따라서 뒤에 ++j 는 실행이 되지 않았음.
		
		boolean result10 = (i == 10) || (++j == 11);
		System.out.println(result10);
		System.out.println("j값은 : " + j);
		
		// or 연산자 역시  위에 조건이 true / true 여서 작동을 안한다. 
		// 따라서 뒤에 ++j도 적용이 되지 않았다. 
		// j의 값은 여전히 10이다. 

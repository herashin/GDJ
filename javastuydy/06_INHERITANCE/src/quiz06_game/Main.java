...
public class Main {
	...
	public static void main(String[] args) {
		...
		GameUnit unit1 = new Tank("탱크"); // 내가 탱크다
		GameUnit unit2 = new Marlin("마린");
		...
		while(unit1.isAlive() && unit2.isAlive()) { //while(unit1.getEnergy) >  0 && unit2.getEnergy() > 0
			...
			//	myTurn = false;
				...
				unit2.attack(unit1); // unit2이 unit1를 공격한다.  ( 마린은 40% 확률로 상대를 한번에 죽임)
			//	myTurn = true; 
			}
			myTurn = !myTurn; // 공격차례를 바꿔준다.

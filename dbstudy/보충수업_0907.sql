...
/*
SELECT B.BOOK_ID , B.BOOK_NAME, B.PUBLISHER, B.PRICE, O.ORDER_DATE
...
--WHERE TO_DATE(O.ORDER_DATE) NOT BETWEEN TO_DATE('17/07/04', 'YY/MM/DD') AND TO_DATE('14/07/07' , 'YY/MM/DD');
...
-- 고객번호순으로 오름차순 정렬하여 조회하시오. ( 고객은 모두 조회, 주문내역은 있는 자료만 조회 = 왼쪽 외부조인)
-- 고객명  총구매액  구매횟수
-- 박지성  116000     3
-- 김연아  19000      2
-- 장미란  62000      3
...
SELECT C.CUSTOMER_NAME AS 고객명
    ...
    , COUNT(ORDER_ID) AS 구매횟수 -- COUNT에는 고객정보가 포함되면 안됨

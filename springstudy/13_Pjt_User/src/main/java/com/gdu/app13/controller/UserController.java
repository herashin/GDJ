...
public class UserController {
   ...
   // 로그인 해야 할 수 있는 작업
      ...
      // 서비스에 넘겨줘야하기 때문에 request, response 다 받아온당 (데이터 흐름 : xml -> 패키지mapper -> 서비스, 서비스impl -> 컨트롤러 -> 뷰)
   ...
   public String 
   logout(HttpServletRequest request, HttpServletResponse response) {   // request로부터 구하기

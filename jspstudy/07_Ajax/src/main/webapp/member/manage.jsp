	...
	function fn_registration(){
		...
		$('#btn_add').click(function(){ 
			...
			$.ajax({
				...
				data: $('#frm_member').serialize(), //serialize()  폼의 모든 입력요소를 파라미터로 변환
				/* 응답 */
				dataType : 'json',
				success: function(resData){
				...
				// 예외응답
				error: function(jqXHR){ // 예외처리 응답 데이터 (일반 텍스트)는 jqXHR 객체의 responseText 속성에 저장됨
